...
(1) Code1.m and body1.m are used to obtain the Fig. 2, Fig. 3, and Table 1 in the paper "A nature inspired intelligent algorithm for a fundamental search problem". 
...
(2) Code2.m and body2.m are used to obtain the Fig. 4 in the paper "A nature inspired intelligent algorithm for a fundamental search problem". 
